                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('special-offer.update', $special_offer->special_offer_id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="discount" type="number" min='1' max="100" step="any" class="form-control{{ $errors->has('discount') ? ' is-invalid' : '' }}" name="discount" value="{{ $special_offer ? $special_offer->discount : old('discount') }}" required>
